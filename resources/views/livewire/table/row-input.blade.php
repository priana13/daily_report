...
>
    <td class="whitespace-nowrap  px-6 py-2 font-medium bg-blue-50">
        ...
        class="border-0 border-gray-300 text-gray-900 text-sm rounded-md block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <td class="whitespace-nowrap  px-6 py-2 text-center bg-blue-50">
        ...
        <select wire:model="kategori" x-show="isEdit" class="border-0 border-gray-300 text-gray-900 text-sm rounded-md block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <td class="whitespace-nowrap  px-6 py-2 text-center bg-blue-50">
        ...
        <select wire:model="status"  x-show="isEdit" class="border-0 border-gray-300 text-gray-900 text-sm rounded-md block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
      ...
      <span x-show="!isEdit" class="bg-{{ $warna }}-200 text-{{ $warna }}-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-{{ $warna }}-900 dark:text-{{ $warna }}-300">
        {{ $laporan->status }}
      </span>
    ...
    <td class="whitespace-nowrap  px-6 py-2 bg-blue-50">
        ...
        <div x-show="!isEdit" class="text-sm text-gray-900 dark:text-white">
            {!! $laporan->deskripsi !!} 
        </div>
